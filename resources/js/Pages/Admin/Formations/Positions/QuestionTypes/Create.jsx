...
export default function AdminFormationPositionQuestionTypeCreate({formation, position, weighting_types, success}) {
    ...
    const submit = (e) => {
        ...
        post(route('admin.formation.position.question-types.store', [formation.id, position.id]), {
            onSuccess: () => {
                reset();
            }
        });
            ...
            <ApplicationLayout>
                ...
                <form method="post" className="mx-auto mt-10" onSubmit={submit}>
                    ...
                    <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            <Select aria-label="Jenis pembobotan soal" name="weighting_type" onChange={handleChange}>
