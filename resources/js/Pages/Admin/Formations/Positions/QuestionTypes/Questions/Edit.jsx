...
export default function AdminFormationPositionQuestionTypeQuestionIndex({
    ...
    const submit = (e) => {
        ...
        put(route('admin.formation.position.question-type.questions.update', [formation.id, position.id, questionType.id, question.id]));
    };
        ...
        <>
            ...
            <ApplicationLayout>
                <div className="max-lg:hidden flex justify-between">
                    <BackButton
                        link={route('admin.formation.position.question-type.questions.show', [formation.id, position.id, questionType.id, question.id])}/>
