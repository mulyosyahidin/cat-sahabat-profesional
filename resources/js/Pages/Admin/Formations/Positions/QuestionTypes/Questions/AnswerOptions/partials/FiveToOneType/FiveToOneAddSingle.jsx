...
export default function FiveToOneAddSingle({formation, position, questionType, question, setOptions}) {
            ...
            <Dialog open={isAddDialogOpen} onClose={() => null} size={'2xl'}>
                ...
                <DialogBody>
                    ...
                    <section className="grid gap-x-8 gap-y-6 sm:grid-cols-12 mt-4">
                        ...
                        <div className="sm:col-span-8">
                            <Input type={'number'} min={'1'} max={'5'} aria-label="Nilai" name="weight" value={data.weight} onChange={handleChange}
                                   required/>
