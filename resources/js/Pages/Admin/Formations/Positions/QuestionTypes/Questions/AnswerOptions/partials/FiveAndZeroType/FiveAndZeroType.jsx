...
import FiveAndZeroTypeAddSingle
    from "@/Pages/Admin/Formations/Positions/QuestionTypes/Questions/AnswerOptions/partials/FiveAndZeroType/FiveAndZeroTypeAddSingle";
import FiveAndZeroTypeAddBulk
    from "@/Pages/Admin/Formations/Positions/QuestionTypes/Questions/AnswerOptions/partials/FiveAndZeroType/FiveAndZeroTypeAddBulk";
...
export default function FiveAndZeroType({ formation, position, question, questionType, newOptionId, newOptions }) {
    ...
    const handleMarkAsCorrectOption = () => {
        patch(route('admin.formation.position.question-type.question.answer-option.mark-as-correct', [formation.id, position.id, questionType.id, question.id, selectedOptionToMark.id]), {
            preserveScroll: true,
            onSuccess: () => {
        ...
        <>
            ...
            <div className="flex justify-between mt-8">
                ...
                <div className={'flex gap-1'}>
                    <FiveAndZeroTypeAddBulk formation={formation} position={position} questionType={questionType} question={question} setOptions={setOptions} newOptions={newOptions} />
                    <FiveAndZeroTypeAddSingle formation={formation} position={position} questionType={questionType} question={question} setOptions={setOptions} />
                </div>
            </div>
