...
export default function AdminQuestionTypeEdit({questionType, weighting_types, success}) {
    ...
    const submit = (e) => {
        ...
        put(route('admin.question-types.update', questionType.id));
    };
    ...
    return (
        <>
            ...
            <ApplicationLayout>
                <div>
                    <BackButton link={route('admin.positions.show', questionType.position.id)}/>
                </div>
                ...
                <form method="post" className="mx-auto mt-10" onSubmit={submit}>
                    ...
                    <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            <Input aria-label="Nama formasi" value={questionType.position.formation.name} disabled />
                        </div>
                    </section>
                    ...
                    <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            <Input aria-label="Nama jabatan" value={questionType.position.name} disabled />
                        </div>
                    </section>
