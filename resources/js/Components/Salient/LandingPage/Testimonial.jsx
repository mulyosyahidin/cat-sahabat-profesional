   ...
   return (
       ...
       >
           <Container className="relative">
               ...
               <div className="mt-16 grid gap-8 md:gap-12 grid-cols-1 lg:grid-cols-3">
                   <div className="pt-8 w-full sm:px-4 lg:col-span-1">
                   ...
                   <div className="pt-8 w-full sm:px-4 lg:col-span-1">
                       <figure className="rounded-2xl bg-gray-50 p-8 text-sm leading-6">
                           <blockquote className="text-gray-900">
                               <p>
                                   Belajar di bimbel Sahabat Karir sangat membantu memahami materi dengan mudah.
                                   Metodenya kreatif dan tentornya sabar dalam menjelaskan
                               </p>
                           </blockquote>
                           <figcaption className="mt-6 flex items-center gap-x-4">
                   ...
                   <div className="pt-8 w-full sm:px-4 lg:col-span-1">
                       <figure className="rounded-2xl bg-gray-50 p-8 text-sm leading-6">
                           <blockquote className="text-gray-900">
                               <p>
                                   Saya merasa lebih percaya diri setelah belajar di sini. Pendekatan personal dari
                                   tentornya membuat suasana belajar lebih menyenangkan dan fokus!
                               </p>
                           </blockquote>
                           <figcaption className="mt-6 flex items-center gap-x-4">
